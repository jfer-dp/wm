...
if Right(errstr, 1) = "." then
	errstr = Left(errstr, Len(errstr) - 1)
end if
...
if errstr = "" then
%>
	<td height="30" style="border:1px solid #8CA5B5;">&nbsp;<img src="images/error.gif" align="absmiddle" border="0">&nbsp;<%=s_lang_0315 %><%=s_lang_jh %></td>
<%
else
%>
	<td height="30" style="border:1px solid #8CA5B5;">&nbsp;<img src="images/error.gif" align="absmiddle" border="0">&nbsp;<%
if sws = "1" then
