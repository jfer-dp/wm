...
if errstr = "" then
%>
	<td height="30" style="border:1px solid #8CA5B5;">&nbsp;<img src="images/error.gif" align="absmiddle" border="0">&nbsp;您的操作<b>失败</b>。</td>
<%
else
%>
	<td height="30" style="border:1px solid #8CA5B5;">&nbsp;<img src="images/error.gif" align="absmiddle" border="0">&nbsp;<%=server.htmlencode(errstr) %>。</td>
<%
end if
%>
	</tr>
