...
function showSending() {
	document.f1.SendMode.value = "post";
	sub(1);
}
...
<% if gourl = "" then %>
		<a class="wwm_btnDownload btn_blue" style="width: 60px;" href="#" onclick="javascript:parent.location.href='showallpf.asp?<%=getGRSN() %>'">取消</a>
<% else %>
