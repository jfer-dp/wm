...
gourl = "listlabel.asp?lbid=" & Server.URLEncode(lbid) & "&page=" & page & "&" & getGRSN()
%>
...
<link rel="stylesheet" type="text/css" href="images/listlabel.css">
...
parent.f1.document.leftval.tgname.value = "<%=Server.URLEncode(lbid) %>";
...
{
	location.href = "listlabel.asp?<%="lbid=" & Server.URLEncode(lbid) & addsortstr & "&" & getGRSN() %>&page=" + document.f1.page.value;
}
...
if lbid <> "--star--" then
	mlb.GetByID lbid, ret_id, ret_title, ret_color

	Response.Write server.htmlencode(ret_title)

	ret_id = NULL
	ret_title = NULL
	ret_color = NULL
else
	Response.Write s_lang_0329
end if
%></font><%
if allnum > 0 then
...
if (parent.f1.document.leftval.purl.value.length > 5)
	document.write("<span class='st_span'><a class='wwm_btnDownload btn_gray' href='javascript:backpl()'><< <%=s_lang_return %></a></span><span style='float:left; width:3px;'>&nbsp;</span>");
...
if page - 1 < 0 then
	...
	bottom_bar = "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & 0 & addsortstr & "&" & getGRSN() & """><img src='images/firstp.gif' border='0' align='absmiddle'></a>&nbsp;"
	bottom_bar = bottom_bar & "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & page - 1 & addsortstr & "&" & getGRSN() & """><img src='images/prep.gif' border='0' align='absmiddle'></a>&nbsp;"
	Response.Write "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & 0 & addsortstr & "&" & getGRSN() & """><img src='images/firstp.gif' border='0' align='absmiddle'></a>&nbsp;"
	Response.Write "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & page - 1 & addsortstr & "&" & getGRSN() & """><img src='images/prep.gif' border='0' align='absmiddle'></a>&nbsp;"
end if
...
if ((page+1) * pageline) => show_allnum then
	...
	bottom_bar = bottom_bar & "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & page + 1 & addsortstr & "&" & getGRSN() & """><img src='images/nextp.gif' border='0' align='absmiddle'></a>&nbsp;"
	Response.Write "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & page + 1 & addsortstr & "&" & getGRSN() & """><img src='images/nextp.gif' border='0' align='absmiddle'></a>&nbsp;"
end if
...
if page + 1 >= allpage then
	...
	bottom_bar = bottom_bar & "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & allpage - 1 & addsortstr & "&" & getGRSN() & """><img src='images/endp.gif' border='0' align='absmiddle'></a>"
	Response.Write "<a href=""listlabel.asp?lbid=" & lbid & "&page=" & allpage - 1 & addsortstr & "&" & getGRSN() & """><img src='images/endp.gif' border='0' align='absmiddle'></a>"
end if
%></span>
    </td>
  </tr>
...
<div id="pmc_more" class="qmpanel_shadow" style="display:none; position:absolute;">
	...
	<table width="100%">
		...
		<div class="menu_item_nofun"><div style="background:#ccc; padding-top:1px; margin-top: 5px;"></div></div>
		<div name="mi" onclick="location.href='labels.asp?<%=getGRSN() %>';" class="menu_item"><%=s_lang_0300 %></div>
	</table>
	</div>
	</div>
</div>
...
<div id="pmc_ck" class="qmpanel_shadow" style="display:none; position:absolute;">
	...
	<table width="100%">
		...
		<div name="mi" onclick="set_ck(3);" class="menu_item"><%=s_lang_0411 %></div>
		<div name="mi" onclick="set_ck(4);" class="menu_item"><%=s_lang_0412 %></div>
	</table>
	</div>
	</div>
</div>
