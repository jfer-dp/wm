...
if Request.ServerVariables("REQUEST_METHOD") = "POST" then
	...
	Response.Redirect "ok.asp?" & getGRSN() & "&gourl=poll_showall.asp"
end if
%>
...
function addnew() {
	...
	document.getElementById("myadd").innerHTML = document.getElementById("myadd").innerHTML + "<div id=\"aim" + curnumber + "\"><%=b_lang_011 %><%=s_lang_mh %><input name=\"name" + curnumber + "\" type=\"text\" class=\"n_textbox\" maxlength=\"64\">\
	&nbsp;&nbsp;<%=b_lang_012 %><%=s_lang_mh %><input name=\"len" + curnumber + "\" type=\"text\" class=\"n_textbox\" maxlength=\"5\" size=\"5\" value=\"0\">\
...
<FORM ACTION="poll_create.asp" METHOD="POST" NAME="f1">
...
<table width="97%" border="0" align="center" cellspacing="0" bgcolor="white">
	...
	<input name="p_title" type="text" class="n_textbox" size="40" maxlength="512">
	</td>
	</tr>
	...
	<input type="text" class="n_textbox" size="5" maxlength="2" name="maxsel" value="1">
	</td>
	</tr>
...
<a class='wwm_btnDownload btn_blue' href="javascript:gosub();"><%=b_lang_032 %></a>
	</td>
	</tr>
</table>
