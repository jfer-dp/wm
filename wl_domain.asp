...
<%
dim ei
set ei = server.createobject("easymail.WhiteListDomain")
ei.Load
...
if Request.ServerVariables("REQUEST_METHOD") = "POST" then
	...
	Response.Redirect "ok.asp?" & getGRSN() & "&gourl=" & Server.URLEncode("wl_domain.asp")
end if
%>
...
<table width="90%" border="0" align="center" cellspacing="0" bgcolor="white">
  <tr valign=bottom align="center">
	<td height="10" style="color:#444444;">&nbsp;<%=b_lang_352 & s_lang_mh %></td>
	<td></td>
	<td style="color:#444444;">&nbsp;<%=b_lang_351 & s_lang_mh %></td>
  </tr>
...
<a class='wwm_btnDownload btn_blue' href="impset.asp?<%=getGRSN() %>#wldomain"><< <%=s_lang_return %></a>
