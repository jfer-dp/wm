...
gourl = "listsh.asp?page=" & page & "&" & getGRSN()
%>
...
.st_5 {width:8%;}
.st_6 {width:6%;}
.st_7 {width:6%; border-right:1px solid #c1c8d2;}
-->
</STYLE>
</HEAD>
...
function showmail(s_url) {
	...
	location.href = "showsh.asp?" + s_url;
}
...
function findit() {
	...
	document.f1.action = "listsh.asp?<%=getGRSN() %>";
	document.f1.submit();
}
...
function selectpage_onchange() {
	location.href = "listsh.asp?<%= getGRSN() & addsortstr %>&page=" + document.f1.page.value;
}

function setsh(fname, ispass) {
	document.f1.mto.value = fname;
	document.f1.gourl.value = "<%=gourl & addsortstr %>";
	document.f1.mode.value = "shone" + ispass;
	document.f1.submit();
}

function sel_sh(ispass) {
	if (ischeck() == true)
	{
		document.f1.gourl.value = "<%=gourl & addsortstr %>";
		document.f1.mode.value = "shmul" + ispass;
		document.f1.submit();
	}
}

function setallsh(ispass) {
	if (ispass == 1)
	{
		if (confirm("<%=s_lang_0595 %>") == false)
			return ;
	}
	else
	{
		if (confirm("<%=s_lang_0596 %>") == false)
			return ;
	}

	document.f1.gourl.value = "<%=gourl & addsortstr %>";
	document.f1.mode.value = "shall" + ispass;
	document.f1.submit();
}
//-->
</SCRIPT>
...
<span class="st_span">
<a class='wwm_btnDownload btn_gray' href='javascript:sel_sh(1)'><%=s_lang_0591 %></a>
</span>
<span style='float:left; width:3px;'>&nbsp;</span>

<span class="st_span">
<a class='wwm_btnDownload btn_gray' href='javascript:sel_sh(0)'><%=s_lang_0592 %></a>
</span>
<span style='float:left; width:3px;'>&nbsp;</span>

<span class="st_span">
<a class='wwm_btnDownload btn_gray' href='javascript:setallsh(1)'><%=s_lang_0593 %></a>
</span>
<span style='float:left; width:3px;'>&nbsp;</span>

<span class="st_span">
<a class='wwm_btnDownload btn_gray' href='javascript:setallsh(0)'><%=s_lang_0594 %></a>
</span>
<span style='float:left; width:3px;'>&nbsp;</span>
...
if page - 1 < 0 then
	...
	bottom_bar = "<a href=""listsh.asp?page=" & 0 & addsortstr & "&" & getGRSN() & """><img src='images/firstp.gif' border='0' align='absmiddle'></a>&nbsp;"
	bottom_bar = bottom_bar & "<a href=""listsh.asp?page=" & page - 1 & addsortstr & "&" & getGRSN() & """><img src='images/prep.gif' border='0' align='absmiddle'></a>&nbsp;"
	Response.Write "<a href=""listsh.asp?page=" & 0 & addsortstr & "&" & getGRSN() & """><img src='images/firstp.gif' border='0' align='absmiddle'></a>&nbsp;"
	Response.Write "<a href=""listsh.asp?page=" & page - 1 & addsortstr & "&" & getGRSN() & """><img src='images/prep.gif' border='0' align='absmiddle'></a>&nbsp;"
end if
...
if ((page+1) * pageline) => allnum then
	...
	bottom_bar = bottom_bar & "<a href=""listsh.asp?page=" & page + 1 & addsortstr & "&" & getGRSN() & """><img src='images/nextp.gif' border='0' align='absmiddle'></a>&nbsp;"
	Response.Write "<a href=""listsh.asp?page=" & page + 1 & addsortstr & "&" & getGRSN() & """><img src='images/nextp.gif' border='0' align='absmiddle'></a>&nbsp;"
end if
...
if page + 1 >= allpage then
	...
	bottom_bar = bottom_bar & "<a href=""listsh.asp?page=" & allpage - 1 & addsortstr & "&" & getGRSN() & """><img src='images/endp.gif' border='0' align='absmiddle'></a>"
	Response.Write "<a href=""listsh.asp?page=" & allpage - 1 & addsortstr & "&" & getGRSN() & """><img src='images/endp.gif' border='0' align='absmiddle'></a>"
end if
%></span>
	</td></tr>
    <tr class="title_tr">
...
do while i < allnum and li < pageline
	...
	show_mail_function = " onclick=""showmail('filename=sh" & idname & "&" & getGRSN() & "&gourl=" & Server.URLEncode(gourl & addsortstr) & "')"""

	is_already_show = true
%>
	<tr id="tr_<%=li %>" class="cont_tr" onmouseover='m_over(this);' onmouseout='m_out(this);'>
...
%></td>
	<td class="cont_td_1"><%
Response.Write "<a href='javascript:setsh(""" & idname & """, 1)'><img src='images/sh_ok.png' border='0' align='absmiddle' title='" & s_lang_0589 & "'></a>"
%></td>
	<td class="cont_td_1"><%
Response.Write "<a href='javascript:setsh(""" & idname & """, 0)'><img src='images/sh_rj.png' border='0' align='absmiddle' title='" & s_lang_0590 & "'></a>"
%></td>
	</tr>
<%
	idname = NULL
...
<div id="pop_win" style="display:none; position:absolute;" class="mydiv">
	<div class="pop_base"><div class="pop_bd bd"><div class="title">
		<div class="title_left"><%=s_lang_find %></div>
